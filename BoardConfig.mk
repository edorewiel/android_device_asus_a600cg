...
TARGET_DEVICE_KERNEL_HEADERS := device/asus/a600cg/kernel-headers
...
# TARGET_KERNEL_CONFIG := a600cg_defconfig
# TARGET_KERNEL_SOURCE := kernel/asus/a600cg
# TARGET_KERNEL_ARCH := x86_64
# BOARD_CUSTOM_BOOTIMG_MK := device/asus/a600cg/intel-boot-tools/boot.mk
# DEVICE_BASE_BOOT_IMAGE := device/asus/a600cg/blobs/boot.img
# BOARD_KERNEL_IMAGE_NAME := bzImage
# TARGET_PREBUILT_KERNEL := out/target/product/a600cg/obj/KERNEL_OBJ/arch/x86/boot/bzImage
# DEVICE_BASE_RECOVERY_IMAGE := device/asus/a600cg/blobs/recovery-WW-3.23.40.52.img

# prebuild source kernel
#BOARD_CUSTOM_BOOTIMG_MK := device/asus/a600cg/intel-boot-tools/boot.mk
#BOARD_CUSTOM_MKBOOTIMG := device/asus/a600cg/intel-boot-tools/boot.mk
#TARGET_PREBUILT_KERNEL := device/asus/a600cg/blobs/bzImage-boot-newDTW
#DEVICE_BASE_BOOT_IMAGE := device/asus/a600cg/blobs/boot_60.img
#DEVICE_BASE_RECOVERY_IMAGE := device/asus/a600cg/blobs/recovery_60.img
...
# Hardware
BOARD_HARDWARE_CLASS := device/asus/a600cg/cmhw
