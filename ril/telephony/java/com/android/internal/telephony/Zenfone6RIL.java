...
/**
 * Provides SignalStrength correction for old Zenfone6RIL extends RIL
 */
public class Zenfone6RIL extends RIL {

    public Zenfone6RIL(Context context, int NetworkType, int cdmaSubscription) {
        super(context, NetworkType, cdmaSubscription);
       mQANElements = 5;
    }

    public Zenfone6RIL(Context context, int NetworkType, int cdmaSubscription, Integer instanceId) {
